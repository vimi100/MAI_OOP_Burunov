...
Trapezoid::Trapezoid() : po{Point(), Point(), Point(), Point()} {}

Trapezoid::Trapezoid(Point& p1, Point& p2, Point& p3, Point& p4) : po{p1, p2, p3, p4}  {}
...
ostream& operator << (ostream& os, const Trapezoid& Trapezoid){ 
    for(size_t i = 0; i < 4; ++i){
        os << Trapezoid.po[i] << endl;
    }
    return os;
}

istream& operator >> (istream& is, Trapezoid& Trapezoid) {
